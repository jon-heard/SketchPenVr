...
namespace Common
{
  ...
  public enum KbdKey
  {
    ...
    // Numpad keys
    [KbdKey(0x60, KeyCode.Keypad0, "0 (numpad)")] Numpad_0,
    [KbdKey(0x61, KeyCode.Keypad1, "1 (numpad)")] Numpad_1,
    [KbdKey(0x62, KeyCode.Keypad2, "2 (numpad)")] Numpad_2,
    [KbdKey(0x63, KeyCode.Keypad3, "3 (numpad)")] Numpad_3,
    [KbdKey(0x64, KeyCode.Keypad4, "4 (numpad)")] Numpad_4,
    [KbdKey(0x65, KeyCode.Keypad5, "5 (numpad)")] Numpad_5,
    [KbdKey(0x66, KeyCode.Keypad6, "6 (numpad)")] Numpad_6,
    [KbdKey(0x67, KeyCode.Keypad7, "7 (numpad)")] Numpad_7,
    [KbdKey(0x68, KeyCode.Keypad8, "8 (numpad)")] Numpad_8,
    [KbdKey(0x69, KeyCode.Keypad9, "9 (numpad)")] Numpad_9,

    // Other keys
    [KbdKey(0xa4, KeyCode.Quote, "Alt (left)")]                      Left_Alt,
    [KbdKey(0xa5, KeyCode.Quote, "Alt (right)")]                     Right_Alt,
    [KbdKey(0xde, KeyCode.Quote, "Apostrophe")]                      Apostrophe,
    [KbdKey(0x6a, KeyCode.KeypadMultiply, "Asterisk (numpad)")]      Numpad_Asterisk,
    ...
    [KbdKey(0x6d, KeyCode.KeypadMinus, "Minus (numpad)")]            Numpad_Minus,
    ...
    [KbdKey(0x6e, KeyCode.KeypadPeriod, "Period (numpad)")]          Numpad_Period,
    [KbdKey(0x6b, KeyCode.KeypadPlus, "Plus (numpad)")]              Numpad_Plus,
    ...
    [KbdKey(0x6f, KeyCode.KeypadDivide, "Slash (numpad)")]           Numpad_Slash,
